...
/* Overrides the load textdomain function for the 'hoot' domain. */
...
/**
 * Overrides the load textdomain functionality when 'hoot' is the domain in use.  The purpose of 
 * this is to allow theme translations to handle the framework's strings.  What this function does is 
 * sets the 'hoot' domain's translations to the theme's.  That way, we're not loading multiple 
