...
function hoot_base_register_sidebars() {
	...
	hoot_register_sidebar(
		array(
			'id'          => 'primary-sidebar',
			'name'        => _x( 'Primary Sidebar', 'sidebar', 'hoot' ),
			'description' => __( 'The main sidebar throughout the site.', 'hoot' )
		)
	);
	...
	hoot_register_sidebar(
		array(
			'id'          => 'topbar-left',
			'name'        => _x( 'Topbar Left', 'sidebar', 'hoot' ),
			'description' => __( 'Leave empty if you dont want to show topbar.', 'hoot' )
		)
	);
	...
	hoot_register_sidebar(
		array(
			'id'          => 'topbar-right',
			'name'        => _x( 'Topbar Right', 'sidebar', 'hoot' ),
			'description' => __( 'Leave empty if you dont want to show topbar.', 'hoot' )
		)
	);
	...
	hoot_register_sidebar(
		array(
			'id'          => 'sub-footer',
			'name'        => _x( 'Sub Footer', 'sidebar', 'hoot' ),
			'description' => __( 'Leave empty if you dont want to show subfooter.', 'hoot' )
		)
	);
