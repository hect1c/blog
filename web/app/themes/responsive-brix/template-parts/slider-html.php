...
<div class="slick"><?php
	foreach ( $hoot_theme->slider as $slide ) :
		if ( !empty( $slide['image'] ) || !empty( $slide['content'] ) ) :
			...
			?><div class="hootslider-html-slide hootslider-html-slide-<?php echo $slide_count; $slide_count++; ?> <?php echo $is_custom_bg; ?>" style="<?php echo esc_attr( $slide_bg ); ?>">
...
<!-- <ul class="slick <?php echo $class; ?>"<?php echo $atts; ?>><?php
	foreach ( $hoot_theme->slider as $slide ) :
		if ( !empty( $slide['image'] ) || !empty( $slide['content'] ) ) :
			...
			?><li class="slick  hootslider-html-slide hootslider-html-slide-<?php echo $slide_count; $slide_count++; ?> <?php echo $is_custom_bg; ?>" style="<?php echo esc_attr( $slide_bg ); ?>">
				<div class="grid"<?php if ( !empty( $gridstyle ) ) echo ' style="' . $gridstyle . '"'; ?>>
