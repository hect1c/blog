...
function hoot_custom_css() {
	...
	$cssrules['.widgetized-template-area.loaded button.slick-prev:hover, .widgetized-template-area.loaded button.slick-next:hover'] = array(
		hoot_css_rule( 'background', $accent_color )
	);

	$cssrules['#menu-primary-items > li a:hover'] = array(
		hoot_css_rule( 'color', $accent_color )
	);

	$cssrules['#topbar .widget_nav_menu li a:hover'] = array(
		hoot_css_rule( 'color', $accent_color )
	);
